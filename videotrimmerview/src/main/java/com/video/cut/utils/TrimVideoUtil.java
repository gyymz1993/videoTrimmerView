...
//        // String cmd = "-ss " + startTime + " -t " + induration + " -i " + inputFile + " -vcodec copy -acodec copy "  + outputFile;
//        //String cmd = "-ss " + startTime + " -t " + induration + " -accurate_seek -i " + inputFile + " -codec copy -avoid_negative_ts 1 " + outputFile;
//        // String cmd;
//        Log.e("TAG", "视频剪切时间:" + induration);
//        String cmd = "-ss " + startTime + " -t " + induration + " -accurate_seek -i " + inputFile + " -codec copy " + outputFile;
//
//        //String cmd = "-ss " + startTime + "-y " + " -i " + inputFile + " -t " + induration + "-vcodec" + "mpeg4" + "-b:v" + "2097152" + "-b:a" + "48000" + "-ac" + "2" + "-ar" + "22050" + outputFile;
//
//        //String[] complexCommand = {"-ss", "" + startMs / 1000, "-y", "-i", yourRealPath, "-t", "" + (endMs - startMs) / 1000, "-vcodec", "mpeg4", "-b:v", "2097152", "-b:a", "48000", "-ac", "2", "-ar", "22050", filePath};
//
////        if (induration > 30) {
////            cmd = "-ss " + startTime + " -t " + induration + " -accurate_seek -i " + inputFile + " -vcodec copy -acodec copy -to " + induration +" " + outputFile + " -y";
////        } else {
////            cmd = "-ss " + startTime + " -t " + induration + " -accurate_seek -i " + inputFile + " -vcodec h264 -acodec aac -avoid_negative_ts 1 " + outputFile;
////        }
//
//        //cmd = "-ss " + startTime + " -t " + induration + " -accurate_seek -i " + inputFile + " -vcodec copy -acodec copy -to " + induration + " " + outputFile + " -y";
...
//    }
     ...
     */
    private static void execFFmpegBinary(Context context, final String[] command, final TrimVideoListener callback) {
...
//    }
    ...
    public static boolean startclipDecodeVideo(String videoPath, String newVideoPath, final long startMs, final long endMs) {
        ...
        if (clipDuration < MIN_SHOOT_DURATION) {
            clipDuration = MIN_SHOOT_DURATION;
        }
     ...
     */
    public static void executeCutVideoCommand( String inputFile, final String outputFile, long startMs, long endMs, final TrimVideoListener callback) {
        double startTime = startMs / 10.0 / 10.0 / 10;
        double induration = (endMs - startMs) / 10.0 / 10.0 / 10;
        String[] complexCommand = {"ffmpeg","-ss", "" + startTime, "-y", "-i", inputFile, "-t", "" + induration, "-vcodec", "mpeg4", "-b:v", "2097152", "-b:a", "48000", "-ac", "2", "-ar", "22050", outputFile};
        FFmpegCmd.exec(complexCommand, 0, new OnEditorListener() {
            ...
            public void onProgress(float progress) {
                Log.d(TAG, "FAILED with onProgress : " + progress);
            }
        });
